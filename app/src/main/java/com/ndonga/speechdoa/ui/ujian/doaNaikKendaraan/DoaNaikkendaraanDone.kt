...
import com.ndonga.speechdoa.databinding.ActivityDoaNaikKendaraanDoneBinding

class DoaNaikKendaraanDone : AppCompatActivity() {
    companion object{
    ...
    private lateinit var binding: ActivityDoaNaikKendaraanDoneBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityDoaNaikKendaraanDoneBinding.inflate(layoutInflater)
        setContentView(binding.root)
        var hasil = ""
        var soal = intent.getStringExtra(DoaNaikKendaraanDone.SOAL)
        var jawaban = intent.getStringExtra(DoaNaikKendaraanDone.JAWABAN)
