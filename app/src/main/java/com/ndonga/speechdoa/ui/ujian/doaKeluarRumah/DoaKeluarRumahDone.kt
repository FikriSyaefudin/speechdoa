...
import com.ndonga.speechdoa.databinding.ActivityDoaKeluarRumahDoneBinding

class DoaKeluarRumahDone : AppCompatActivity() {
    companion object{
    ...
    private lateinit var binding: ActivityDoaKeluarRumahDoneBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityDoaKeluarRumahDoneBinding.inflate(layoutInflater)
        setContentView(binding.root)
        var hasil = ""
        var soal = intent.getStringExtra(DoaKeluarRumahDone.SOAL)
        var jawaban = intent.getStringExtra(DoaKeluarRumahDone.JAWABAN)
