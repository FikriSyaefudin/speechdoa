...
import com.ndonga.speechdoa.databinding.ActivityDoaBercerminDoneBinding

class DoaBercerminDone : AppCompatActivity() {
    companion object{
    ...
    private lateinit var binding: ActivityDoaBercerminDoneBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityDoaBercerminDoneBinding.inflate(layoutInflater)
        setContentView(binding.root)
        var hasil = ""
        var soal = intent.getStringExtra(DoaBercerminDone.SOAL)
        var jawaban = intent.getStringExtra(DoaBercerminDone.JAWABAN)
