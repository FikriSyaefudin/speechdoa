...
import com.ndonga.speechdoa.databinding.ActivityDoaMemakaiPakaianDoneBinding

class DoaMemakaiPakaianDone : AppCompatActivity() {
    companion object{
    ...
    private lateinit var binding: ActivityDoaMemakaiPakaianDoneBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityDoaMemakaiPakaianDoneBinding.inflate(layoutInflater)
        setContentView(binding.root)
        var hasil = ""
        var soal = intent.getStringExtra(DoaMemakaiPakaianDone.SOAL)
        var jawaban = intent.getStringExtra(DoaMemakaiPakaianDone.JAWABAN)
