...
import com.ndonga.speechdoa.databinding.ActivityDoaMengawaliPekerjaanDoneBinding
...
class DoaMengawaliPekerjaanDone : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var hasil = ""
        var soal = intent.getStringExtra(DoaMengawaliPekerjaanDone.SOAL)
        var jawaban = intent.getStringExtra(DoaMengawaliPekerjaanDone.JAWABAN)
