...
import com.ndonga.speechdoa.databinding.ActivityDoaMasukRumahDoneBinding

class DoaMasukRumahDone : AppCompatActivity() {
    companion object{
    ...
    private lateinit var binding: ActivityDoaMasukRumahDoneBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityDoaMasukRumahDoneBinding.inflate(layoutInflater)
        setContentView(binding.root)
        var hasil = ""
        var soal = intent.getStringExtra(DoaMasukRumahDone.SOAL)
        var jawaban = intent.getStringExtra(DoaMasukRumahDone.JAWABAN)
