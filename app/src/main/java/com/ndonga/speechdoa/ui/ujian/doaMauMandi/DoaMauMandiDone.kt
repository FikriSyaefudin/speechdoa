...
import com.ndonga.speechdoa.databinding.ActivityDoaMauMandiDoneBinding

class DoaMauMandiDone : AppCompatActivity() {
    companion object{
    ...
    private lateinit var binding: ActivityDoaMauMandiDoneBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityDoaMauMandiDoneBinding.inflate(layoutInflater)
        setContentView(binding.root)
        var hasil = ""
        var soal = intent.getStringExtra(DoaMauMandiDone.SOAL)
        var jawaban = intent.getStringExtra(DoaMauMandiDone.JAWABAN)
