...
import com.ndonga.speechdoa.databinding.ActivityDoaMelepasPakaianDoneBinding

class DoaMelepasPakaianDone : AppCompatActivity() {
    companion object{
    ...
    private lateinit var binding: ActivityDoaMelepasPakaianDoneBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityDoaMelepasPakaianDoneBinding.inflate(layoutInflater)
        setContentView(binding.root)
        var hasil = ""
        var soal = intent.getStringExtra(DoaMelepasPakaianDone.SOAL)
        var jawaban = intent.getStringExtra(DoaMelepasPakaianDone.JAWABAN)
