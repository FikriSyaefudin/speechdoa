...
import com.ndonga.speechdoa.databinding.ActivityDoaKeluarMasjidDoneBinding
...
//        setContentView(R.layout.activity_doa_keluar_Masjid_done)
        ...
        var hasil = ""
        var soal = intent.getStringExtra(DoaKeluarMasjidDone.SOAL)
        var jawaban = intent.getStringExtra(DoaKeluarMasjidDone.JAWABAN)
