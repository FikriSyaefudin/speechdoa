...
import com.ndonga.speechdoa.databinding.ActivityDoaSampaiDiRumahDoneBinding

class DoaSampaiDiRumahDone : AppCompatActivity() {
    companion object{
    ...
    private lateinit var binding: ActivityDoaSampaiDiRumahDoneBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityDoaSampaiDiRumahDoneBinding.inflate(layoutInflater)
        setContentView(binding.root)
        var hasil = ""
        var soal = intent.getStringExtra(DoaSampaiDiRumahDone.SOAL)
        var jawaban = intent.getStringExtra(DoaSampaiDiRumahDone.JAWABAN)
