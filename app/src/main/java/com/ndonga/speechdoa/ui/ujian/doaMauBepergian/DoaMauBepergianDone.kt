...
import com.ndonga.speechdoa.databinding.ActivityDoaMauBepergianDoneBinding

class DoaMauBepergianDone : AppCompatActivity() {
    companion object{
    ...
    private lateinit var binding: ActivityDoaMauBepergianDoneBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityDoaMauBepergianDoneBinding.inflate(layoutInflater)
        setContentView(binding.root)
        var hasil = ""
        var soal = intent.getStringExtra(DoaMauBepergianDone.SOAL)
        var jawaban = intent.getStringExtra(DoaMauBepergianDone.JAWABAN)
